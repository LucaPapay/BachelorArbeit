...
export const addCategoryToInventories = (entry, id) => ({ type: ADD_CATEGORY_TO_INVENTORIES, newEntry: entry, id: id, parentIds: parentIds });
export const addEntryToCategory = (id, entry, parentIds) => ({ type: ADD_TO_INVENTORIES, id: id, newEntry: entry, parentIds: parentIds });
